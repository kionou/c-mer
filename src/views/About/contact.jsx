                    ...
                    <div className="col-xl-6">
                        <div className="wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-6">
                                        <div className="contact-add-item">
                                            ...
                                            <div>
                                                <h4>Mail Us</h4>
                                                <p className="mb-0">support@c-mer.org</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="contact-add-item">
                                            ...
                                            <div>
                                                <h4>Telephone</h4>
                                                <p className="mb-0">(+000) 0000 0000</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                            ...
                            <div className="bg-light p-5 rounded h-100 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <p className="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and youre done. <a className="text-primary fw-bold" href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                                <form>
                                    <div className="row g-4">
